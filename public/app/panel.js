...
function renderPanel(){
  ...
  if(etSelected)html+=etHealthHTML(etSelected,true)+etSkillHTML(etSelected,true)+etEquipmentHTML(etSelected,true)+etCombatHTML(etSelected,true);
