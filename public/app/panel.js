...
function renderClientPanel(){
  ...
  if(App.session.campaignId==="east-tennessee-1861"&&!mineActor)html+=etCharactersHTML(false)+etNpcsHTML(false);
  if(mineActor){
    html+=etCharactersHTML(false)+etNpcsHTML(false)+etTalentControlsHTML(mineActor,false)+etHealthHTML(mineActor,false)+etSkillHTML(mineActor,false)+etEquipmentHTML(mineActor,false)+etCombatHTML(mineActor,false);
