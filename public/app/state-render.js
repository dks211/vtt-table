...
/* ---------------- the Verso floor plan (built-in level) ---------------- */
...
const VERSO_LEVEL={name:"The Verso · Back of House", bg:"#0A0F0C", rooms:VERSO_ROOMS, doors:VERSO_DOORS};
const TEMPLATES=[
...
const state = {
  ...
  verso:{
    revealed:{white:true},
    tokens:[
      mkTok("Randy Meisner","R","#8A6FB8",3.5,3.5,1,true),
      mkTok("Trajan","T","#4E8F86",4.5,4.5,1,true),
