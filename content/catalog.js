...
const VAULT_ROOMS=[
 ...
 {id:"underpass2",name:"The Unfinished Passage",sub:"nothing of the casino remains",rect:{x:5,y:9,w:3,h:3},
  floorA:"#303A32",floorB:"#29322B",wall:"#4E594F",corridor:true,masonry:true,light:"torchlight",revealMode:"armed",
  read:"Beyond the landing is a short chamber the casino never finished disguising. There is no carpet, no brass, no mirror—only close-set blocks, soot-black mortar, and two iron torches bending in a draft from below. The ceiling is low enough to touch. Chisel marks continue beneath the floor, as though this passage was cut out of a much larger sentence.",
  dm:"<b>LET THIS ROOM BREATHE FOR THIRTY SECONDS.</b> No puzzle and no encounter. It is the clean visual break between the Verso and Level 2: casino behind them, dungeon around them. Footsteps now echo like a crypt. The next arch reintroduces gilt fixtures, but only as a thin layer fastened onto this older construction.",
  clues:["The blocks predate Val du Cendre's modern foundations.","Warm under-writing occupies the mortar joints, not the stone faces.","The draft comes from deeper than the visible floor plan allows."]},
 {id:"mirrors2",name:"The Mirror Gallery",sub:"five junctions · three arches each",rect:{x:8,y:9,w:11,h:3},
  floorA:"#39443A",floorB:"#303A32",wall:"#596052",corridor:true,masonry:true,light:"torchlight",revealMode:"armed",
  read:"The raw passage opens into a gallery built from the same blocks, but here the casino has returned in pieces: gilt mirror-plates bolted over old mortar, brass trim stopping wherever the stone refuses a nail, velvet worn thin across flagstones. At the first junction, three arches wait. Each looks open from here. In the brass mirror opposite them, two reflections end at blank stone a few feet in. The third keeps going.",
...
const VAULT_PROPS=[
 ...
 {id:"underpass-torch-a",t:"wallsconce",x:5.2,y:9.05,label:"Underpass torch",playerLabel:"Iron wall torch",playerInspect:"Soot has collected here for generations."},{id:"underpass-torch-b",t:"wallsconce",x:7.1,y:11.05,rotation:2,label:"Underpass torch",playerLabel:"Iron wall torch"},{id:"underpass-rubble",t:"rubble",x:6.15,y:10.25,label:"Chisel spoil",playerLabel:"Old masonry fragments",scale:.7},
 {id:"mirror-1",t:"mirror",x:8.2,y:9.05,label:"North mirror A",playerLabel:"Gilt mirror"},{id:"mirror-2",t:"mirror",x:9.9,y:9.05,label:"North mirror B",playerLabel:"Gilt mirror"},
 {id:"mirror-3",t:"mirror",x:11.6,y:9.05,label:"North mirror C",playerLabel:"Gilt mirror"},{id:"mirror-4",t:"mirror",x:13.3,y:9.05,label:"North mirror D",playerLabel:"Gilt mirror"},
 {id:"mirror-5",t:"mirror",x:15,y:9.05,label:"North mirror E",playerLabel:"Gilt mirror",playerInspect:"Its reflection carries depth that the direct view refuses to show."},{id:"mirror-6",t:"mirror",x:16.7,y:9.05,label:"North mirror F",playerLabel:"Tarnished mirror"},
 {id:"mirror-7",t:"mirror",x:8.7,y:11.05,rotation:2,label:"South mirror A",playerLabel:"Gilt mirror"},{id:"mirror-8",t:"mirror",x:10.5,y:11.05,rotation:2,label:"South mirror B",playerLabel:"Gilt mirror"},
 {id:"mirror-9",t:"mirror",x:12.3,y:11.05,rotation:2,label:"South mirror C",playerLabel:"Fractured mirror"},{id:"mirror-10",t:"mirror",x:14.1,y:11.05,rotation:2,label:"South mirror D",playerLabel:"Gilt mirror"},
 {id:"mirror-11",t:"mirror",x:15.9,y:11.05,rotation:2,label:"South mirror E",playerLabel:"Gilt mirror"},
 {id:"mirror-lamp-1",t:"wallsconce",x:9.6,y:11.05,rotation:2,label:"Gallery torch"},{id:"mirror-lamp-2",t:"wallsconce",x:12,y:11.05,rotation:2,label:"Gallery torch"},
 {id:"mirror-lamp-3",t:"wallsconce",x:14.4,y:11.05,rotation:2,label:"Gallery torch"},{id:"mirror-lamp-4",t:"wallsconce",x:16.8,y:11.05,rotation:2,label:"Gallery torch"},
